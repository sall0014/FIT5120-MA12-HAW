...
$result = $wpdb->get_results( "SELECT tide_time, round(min(tide_height),2) AS minHeight FROM `tide_rockshelves` WHERE tide_date = '$request_date' AND location_name = 'Cape Schanck'");
...
foreach ($result as $row) {
    ...
    if ($tide_height >= 0.5){
        echo "It is a ". "<i style='color:red;'><b>RISKY</b></i>". " day to travel to the Cape Schanck!";
    }else{
