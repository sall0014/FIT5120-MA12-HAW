...
namespace ShopMagicTwilioVendor\WPDesk\PluginBuilder\Builder;
...
use ShopMagicTwilioVendor\WPDesk\PluginBuilder\Storage\PluginStorage;
/**
 ...
 */
class InfoActivationBuilder extends \ShopMagicTwilioVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
     ...
     */
    public function __construct(\ShopMagicTwilioVendor\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;
    ...
    public function build_plugin()
    {
        ...
        if ($this->plugin instanceof \ShopMagicTwilioVendor\WPDesk\PluginBuilder\Plugin\ActivationAware && $this->is_active) {
            $this->plugin->set_active();
        }
        return $this->plugin;
    }
    public function store_plugin(\ShopMagicTwilioVendor\WPDesk\PluginBuilder\Storage\PluginStorage $storage)
    {
