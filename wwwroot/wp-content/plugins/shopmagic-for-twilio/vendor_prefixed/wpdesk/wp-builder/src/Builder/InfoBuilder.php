 ...
 */
class InfoBuilder extends \ShopMagicTwilioVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
    ...
    public function __construct(\ShopMagicTwilioVendor\WPDesk_Buildable $info)
    {
        $this->info = $info;
