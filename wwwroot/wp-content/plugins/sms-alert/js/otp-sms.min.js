...
{
	if(typeof hide_default_login_form !='undefined' && hide_default_login_form=='on')
	{
...
jQuery(document).on("click",".sa-lwo-form .sa-otp-btn-init",function(){
	...
	if(mob_field.val()=='')
	{
		var enter_mob_no 	= (typeof sa_notices !=  'undefined' && sa_notices['enter_mob_no']) ? sa_notices['enter_mob_no'] : "";jQuery(".sa_phone_error").html(enter_mob_no).fadeIn().css({"color":"red"});
		return;
	}
...
function saInitOTPProcess(obj,action_url, data_obj,otp_resend_timer=15,success_cb=null,failure_cb=null)
{
	...
	var prev_btn_text 	= cur_btn.val();
		if(cur_btn.is("input")){
			...
			cur_btn.text(waiting_txt).attr("disabled",true);
		}
