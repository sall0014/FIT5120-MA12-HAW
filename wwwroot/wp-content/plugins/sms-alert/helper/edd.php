...
class SmsAlertEdd
{
	...
	public static function addTabs($tabs=array())
	{
		...
		$tabs['edd']['inner_nav']['edd_customer']['tabContent']	= self::getContentFromTemplate('views/message-template.php',$customer_param);

		$tabs['edd']['inner_nav']['edd_admin']['title']			= 'Admin Notifications';
		$tabs['edd']['inner_nav']['edd_admin']['tab_section'] 	= 'eddadmintemplates';
		$tabs['edd']['inner_nav']['edd_admin']['tabContent']	= self::getContentFromTemplate('views/message-template.php',$admin_param);
		return $tabs;
	}
	...
	public static function getCustomerTemplates()
	{
		...
		foreach($edd_order_statuses as $ks  => $vs){
			...
			$checkboxNameId		= 'smsalert_edd_general[edd_order_status_'.str_replace(' ', '_',$vs).']';
			$textareaNameId		= 'smsalert_edd_message[edd_sms_body_'.$vs.']';

			$text_body 			= smsalert_get_option('edd_sms_body_'.$vs, 'smsalert_edd_message',
	...
	public static function getAdminTemplates()
	{
		...
		foreach($edd_order_statuses as $ks  => $vs){
			...
			$checkboxNameId		= 'smsalert_edd_general[edd_admin_notification_'.str_replace(' ', '_',$vs).']';
			$textareaNameId		= 'smsalert_edd_message[edd_admin_sms_body_'.$vs.']';

			$text_body 			= smsalert_get_option('edd_admin_sms_body_'.$vs, 'smsalert_edd_message',
